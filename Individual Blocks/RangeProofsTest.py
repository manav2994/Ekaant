...
''' 
This Script demonstrates an example of Non-Interactive ZK Proof of Range - Protocols
'''
...
H = ECElgamal.ECadd(base_point[0], base_point[1], base_point[0], base_point[1], a, b, mod) #2G
...
#Public Key (K = kG) | Ka, Kb, Kc and Kq
...
print("\nCollective Authority Public key: ", caPublicKey)
...
print("M2 is represented as the following point coordinates")
...
r = Secret(value=Bn(int(M1+M2)))
rangeStmt = RangeOnlyStmt(0, 100, r) 
nizk = rangeStmt.prove()
if(rangeStmt.verify(nizk)==True):
	print("The sum is VERIFIED within the range of 1 and 100")
else:
